...
namespace Quantum.Profiling
{
    ...
    public sealed class MarkersProfiler : MarkerSeriesProfiler
    {
		public static readonly List<MarkersProfiler> Instances = new List<MarkersProfiler>();
		...
		public static MarkersProfiler Get(string name)
		{
			for (int i = 0; i < Instances.Count; ++i)
			{
				MarkersProfiler profiler = Instances[i];
